...
void output();
// Superior Function
void sys_reset(float Output_C_Distribution[NUMNODE], float Output_R_Distribution_Past[NUMNODE], float Output_RU_Distribution[NUMNODE], float Output_RO_Distribution[NUMNODE]);
void execution(int Action, int time_id, float Output_C_Distribution[NUMNODE], float Output_R_Distribution_Past[NUMNODE], float Output_RU_Distribution[NUMNODE], float Output_RO_Distribution[NUMNODE], float Output_Reward[1]);

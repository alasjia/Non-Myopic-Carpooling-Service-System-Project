...
void output()
{
    int i = 0, j = 0;
    // 创建文件指针
    FILE *fp_RouteList = fopen("/home/chwei/JeanLu/SharedTaxi/C_python/dataoutput/CNN_500Veh/Car_RouteList_Policy1.csv", "w+");
    FILE *fp_Chair = fopen("/home/chwei/JeanLu/SharedTaxi/C_python/dataoutput/CNN_500Veh/TaskList_Chair_Policy1.csv", "w+");
    FILE *fp_FinishTime = fopen("/home/chwei/JeanLu/SharedTaxi/C_python/dataoutput/CNN_500Veh/TaskList_FinishTime_Policy1.csv", "w+");
    FILE *fp_Cost_Reward = fopen("/home/chwei/JeanLu/SharedTaxi/C_python/dataoutput/CNN_500Veh/ReqList_Cost_Reward_Policy1.csv", "w+");
    FILE *fp_WaitTimeOrDetourTime = fopen("/home/chwei/JeanLu/SharedTaxi/C_python/dataoutput/CNN_500Veh/TaskList_WaitTimeOrDetourTime_Policy1.csv", "w+");
    FILE *fp_NextTask = fopen("/home/chwei/JeanLu/SharedTaxi/C_python/dataoutput/CNN_500Veh/TaskList_NextTaskID_Policy1.csv", "w+");
    // 出错处理,避免传入空指针

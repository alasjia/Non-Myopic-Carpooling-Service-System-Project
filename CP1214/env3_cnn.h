...
void output()
{
    int i = 0, j = 0;
    // 创建文件指针
    // FILE *fp_RouteList = fopen("/home/chwei/JeanLu/SharedTaxi/C_python/dataoutput/Policy2_CNN_500Veh/Car_RouteList_0212.csv", "w+");
    FILE *fp_Chair = fopen("/home/chwei/JeanLu/SharedTaxi/C_python/dataoutput/Policy2_CNN_500Veh/TaskList_Chair_0212.csv", "w+");
    FILE *fp_FinishTime = fopen("/home/chwei/JeanLu/SharedTaxi/C_python/dataoutput/Policy2_CNN_500Veh/TaskList_FinishTime_0212.csv", "w+");
    FILE *fp_Cost_Reward = fopen("/home/chwei/JeanLu/SharedTaxi/C_python/dataoutput/Policy2_CNN_500Veh/ReqList_Cost_Reward_0212.csv", "w+");
    FILE *fp_WaitTimeOrDetourTime = fopen("/home/chwei/JeanLu/SharedTaxi/C_python/dataoutput/Policy2_CNN_500Veh/TaskList_WaitTimeOrDetourTime_0212.csv", "w+");
    FILE *fp_NextTask = fopen("/home/chwei/JeanLu/SharedTaxi/C_python/dataoutput/Policy2_CNN_500Veh/TaskList_NextTaskID_0212.csv", "w+");

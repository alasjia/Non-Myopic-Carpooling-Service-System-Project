...
gcc -o lib1214_fc.so -shared -fPIC main_fc.c
*/
...
*/
void execution(float Actions[NUMCHAIR + 1], int time_id, float Car_Distribution[NUMNODE], float Req_Distribution[NUMNODE], float Car_Location[NUMNODE], float reward[1])
{

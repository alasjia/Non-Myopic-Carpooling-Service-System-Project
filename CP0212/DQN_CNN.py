...
def save_parameters():
    ...
    torch.save(obj=qnet_paras, f="CP0212/qnet_paras_save2.pth")

# 重载模型参数
def reload_parameters():
    #state_dict() 只保存网络参数，不保存网络结构
    reload_states = torch.load("CP0212/qnet_paras_save2.pth")#重载的reload_states 为一个字典
...
if __name__ == '__main__':
    ...
    env = ll(r"/home/chwei/JeanLu/SharedTaxi/C_python/CP0212/libPolicy2_0212.so")  
...
# 设置agent
    ...
    for ep in range(MAX_EPISODES):
        ...
        for t in range(MAX_EP_STEPS):     
            ...
            env.execution(a_c, t_c, Car_Distribution, Car_Distribution_15, Car_Distribution_30, Req_Distribution, Req_Distribution_15, Req_Distribution_30, Car_Location, Reward)

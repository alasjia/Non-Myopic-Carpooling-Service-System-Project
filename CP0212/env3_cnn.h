...
void match(int req_id, int car_id)
{
    ...
    if (forwardtask < 0)
    {
        ...
        if (waittime > WAITTHRESHOLD)
            feasible_switch = 0;
        // // 测试：判断乘客数                     【为什么加该判断条件后不超数了？？？】
        // if ((chair_num + 1) > NUMCHAIR)
        //     feasible_switch = 0;
...
void output()
{
    int i = 0, j = 0;
    // 创建文件指针
    // FILE *fp_RouteList = fopen("/home/chwei/JeanLu/SharedTaxi/C_python/dataoutput/Policy2_CNN_500Veh/Car_RouteList_0227p3.csv", "w+");
    FILE *fp_Chair = fopen("/home/chwei/JeanLu/SharedTaxi/C_python/dataoutput/Policy2_CNN_500Veh/TaskList_Chair_0227p3.csv", "w+");
    FILE *fp_FinishTime = fopen("/home/chwei/JeanLu/SharedTaxi/C_python/dataoutput/Policy2_CNN_500Veh/TaskList_FinishTime_0227p3.csv", "w+");
    FILE *fp_Cost_Reward = fopen("/home/chwei/JeanLu/SharedTaxi/C_python/dataoutput/Policy2_CNN_500Veh/ReqList_Cost_Reward_0227p3.csv", "w+");
    FILE *fp_WaitTimeOrDetourTime = fopen("/home/chwei/JeanLu/SharedTaxi/C_python/dataoutput/Policy2_CNN_500Veh/TaskList_WaitTimeOrDetourTime_0227p3.csv", "w+");
    FILE *fp_NextTask = fopen("/home/chwei/JeanLu/SharedTaxi/C_python/dataoutput/Policy2_CNN_500Veh/TaskList_NextTaskID_0227p3.csv", "w+");
...
void update_15(int time_id, int car_id)
{
    ...
    if (forwardtaskid >= 0)
    {
        ...
        /*更新15分钟后的车辆位置*/
        CarState_Node_15[car_id] = curnode;
    }
}
...
void update_30(int time_id, int car_id)
{
    ...
    if (forwardtaskid >= 0)
    {
        ...
        /*更新15分钟后的车辆位置*/
        CarState_Node_30[car_id] = curnode;
    }
}
